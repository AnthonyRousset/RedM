...
export const useAdminStore = defineStore('admin', {
    state: () => ({
        ...
        locationList: [
            ...
            { label: "Tumbleweed", value: "tumbleweed" },
            { label: "Lagras", value: "lagras" },
            { label: "Annesburg", value: "anniesburg" },
            { label: "Van Horn", value: "van_horn" },
        ...
        classList: [
            ...
            { label: "Ecurie", model: "stable" },
            { label: "Poste", model: "mail" },
            { label: "Sécurité", model: "sherif" },
            { label: "Poker", model: "poker" },
            { label: "Blackjack", model: "blackjack" }
        ],
